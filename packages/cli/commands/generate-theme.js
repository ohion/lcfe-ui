...
const lightTheme = require('../../lcfe-ui/ui/theme/themes/light.ts').default;
const darkTheme = require('../../lcfe-ui/ui/theme/themes/dark.ts').default;
...
exports.generateTheme = async () => {
  const lightThemeFilePath = path.resolve(
    __dirname,
    '../../lcfe-ui/ui/theme/theme.scss'
  );

  // 生成深色主题css文件
  const darkThemeFilePath = path.resolve(
    __dirname,
    '../../lcfe-ui/ui/theme/darkTheme.css'
  );
